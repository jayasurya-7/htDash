...
TRACK = [
    ...
    DayEntry(cohort_day=0, role='ctrl4', events=[
        ScriptedEvent(
    ...
    DayEntry(cohort_day=1, role='ctrl4', events=[
        ScriptedEvent(
    ...
    DayEntry(cohort_day=2, role='ctrl4', events=[
        ScriptedEvent(
    ...
    DayEntry(cohort_day=3, role='ctrl4', events=[
        ScriptedEvent(
    ...
    *[DayEntry(cohort_day=day, role='ctrl4', events=[], trainer_note='No activities due.') for day in range(4, 7)],

    DayEntry(cohort_day=7, role='ctrl4', events=[
        ScriptedEvent(
    ...
    DayEntry(cohort_day=8, role='ctrl4', events=[
        ScriptedEvent(
    ...
    # ── Days 9-11: Quiet ──
    *[DayEntry(cohort_day=day, role='ctrl4', events=[], trainer_note='No activities due.') for day in range(9, 12)],

    # ── Day 12: Patient calls about device battery ──
    DayEntry(cohort_day=12, role='ctrl4', events=[
        ScriptedEvent(
            event_key='patient_call', kind='free',
    ...
    *[DayEntry(cohort_day=day, role='ctrl4', events=[], trainer_note='No activities due.') for day in range(13, 17)],

    # ── Day 17: DISCONTINUATION - Patient withdraws due to personal reasons ──
    DayEntry(cohort_day=17, role='ctrl4', events=[
        ScriptedEvent(
    ...
    *[DayEntry(cohort_day=day, role='ctrl4', events=[], trainer_note='Patient discontinued. Training paused. Awaiting A1/A2 assessments.') for day in range(18, 180)],
    ...
    # ── Days 181-182: Quiet ──
    *[DayEntry(cohort_day=day, role='ctrl4', events=[], trainer_note='No activities due.') for day in range(181, 183)],

    # ── Day 183: A1 Assessment ──
    DayEntry(cohort_day=183, role='ctrl4', events=[
        ScriptedEvent(
    ...
    # ── Days 184-186: Quiet ──
    *[DayEntry(cohort_day=day, role='ctrl4', events=[], trainer_note='No activities due.') for day in range(184, 187)],

    # ── Day 187: End of study period ──
    DayEntry(cohort_day=187, role='ctrl4', events=[], trainer_note='Study period complete. A2 assessment completed separately.'),
]
