...
TRACK = [
    ...
    DayEntry(cohort_day=1, role='ctrl2', events=[
        ...
        ScriptedEvent(
            ...
            fields={
                'exercises': [
                    ...
                    {'exercise_name': 'Reach and grasp', 'type': 'vcg', 'start': '06:30', 'end': '10:15', 'notes': ''},
        ...
        ScriptedEvent(
            ...
            fields={
                ...
                'attachment_caption': 'Photo of watch worn correctly on left wrist.',
            },
        ),
        ScriptedEvent(
        ...
        ScriptedEvent(
            ...
            fields={
                'exercises': [
                    {'exercise_name': 'Practice Brushing Your Teeth', 'type': 'adl', 'start': '06:00', 'end': '06:08', 'notes': ''},
                    {'exercise_name': 'Practice Combing Your Hair', 'type': 'adl', 'start': '06:10', 'end': '06:25', 'notes': ''},
                    {'exercise_name': 'Reach and grasp', 'type': 'vcg', 'start': '06:30', 'end': '14:15', 'notes': ''},
    ...
    DayEntry(cohort_day=12, role='ctrl2', events=[
        ScriptedEvent(
            ...
            fields={
                ...
                'attachment': 'device_setup_support_notes.pdf',
                'attachment_caption': 'Notes from technical support call about modem and watch battery.',
            },
        ),
    ]),
    ...
    DayEntry(cohort_day=15, role='ctrl2', events=[
        ScriptedEvent(
            event_key='watch_record', kind='free',
            narrative='Therapist checks and records AG watch status on left hand. Watch battery low, swap to new watch.',
            fields={
                'ag_watch_left': {'watch_number': 'TRNDEV-AGW-8', 'old_lost': False},
                'sync_datetime': '{today} 14:00',
                'worn_datetime': '{today} 14:00',
                'next_followup_days': 14,
                'notes': 'Left watch battery low. Swapped old watch (TRNDEV-AGW-5) to new watch (TRNDEV-AGW-8). Patient wearing consistently.',
                'attachment': '',
                'attachment_caption': '',
            },
        ),
        ScriptedEvent(
            ...
            fields={
                ...
                'data_start': '{today}',
                'data_end': '{today}',
                'notes': 'Watch data uploaded from removed watch. New watch TRNDEV-AGW-8 now assigned.',
            },
        ),
        ScriptedEvent(
        ...
        ScriptedEvent(
            ...
            fields={
                'exercises': [
                    ...
                    {'exercise_name': 'Reach and grasp', 'type': 'vcg', 'start': '14:00', 'end': '14:20', 'notes': ''},
    ...
    DayEntry(cohort_day=19, role='ctrl2', events=[
        ScriptedEvent(
            ...
            fields={
                ...
                'attachment': 'exercise_intensity_notes.pdf',
                'attachment_caption': 'Call notes on exercise intensity verification.',
            },
        ),
    ]),
    ...
    DayEntry(cohort_day=29, role='ctrl2', events=[
        ...
        ScriptedEvent(
            ...
            fields={
                ...
                'devices': [
                    {'type': 'agwatch', 'device_id': 'TRNDEV-AGW-8', 'status': 'working', 'notes': 'Returned, functioning normally.'},
                ],
    ...
    # Days 30-32 quiet
    *[
        DayEntry(cohort_day=day, role='ctrl2', events=[], trainer_note='A1 assessment scheduled.' if day == 32 else 'No activities due.')
